package com.melo.netty.heart.handler;

import com.melo.netty.common.pojo.CustomProtocol;
...
public class HeartbeatSimpleHandler extends SimpleChannelInboundHandler<CustomProtocol> {
    ...
    private static final ByteBuf HEART_BEAT =  Unpooled.unreleasableBuffer(Unpooled.copiedBuffer(new CustomProtocol("pong", 123456L).toString(),CharsetUtil.UTF_8));
    ...
    @Override
    protected void messageReceived(ChannelHandlerContext channelHandlerContext, CustomProtocol customProtocol) throws Exception {
